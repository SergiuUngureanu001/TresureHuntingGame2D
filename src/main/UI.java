...
public class UI {
    ...
    public void drawCharacterScreen() {
        ...
        g2.drawImage(gp.player.currentWeapon.down1, tailX - GamePanel.tileSize, textY - 15, null);
        textY += lineHeight;
        g2.drawImage(gp.player.currentShield.down1, tailX - GamePanel.tileSize, textY, null);
